"""Transit-window analysis of a real TESS SPOC light curve for HD 106315 b.
...
DATA_FILE = DATA_DIR / "tess2021336043614-s0046-0000000056815340-0217-s_lc.fits"
PLANET = "HD 106315 b"
PERIOD_DAYS = 9.55237
EPOCH_BJD = 2457586.5487
DURATION_HOURS = 3.775
SECTOR = 46
FIGURE_FILE = FIG_DIR / "hd106315b_tess_transit.png"
...
def main() -> dict[str, float]:
    ...
    ax.scatter(hours, (result["flux"] - 1) * 1e6, s=5, alpha=0.12, color="#0c8599", label="quality-filtered cadences")
    ...
    ax.plot(hours[order], (result["model"][order] - 1) * 1e6,
            color="#0c8599", linewidth=2.2, label="fitted box model")
    ax.axvspan(-DURATION_HOURS / 2.0, DURATION_HOURS / 2.0, color="#0c8599", alpha=0.08)
